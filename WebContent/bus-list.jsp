...
<button onclick="window.location.href='bus-form.jsp'"> Bus Form </button>
<br><br>
...
<c:url var="updateFormLink" value="bus">
<c:param name="mode" value="UPDATE_FORM" />
...
<c:url var="viewPassengersLink" value="bus">
<c:param name="mode" value="VIEW_PASSENGERS" />
<c:param name="busId" value="${bus.busId }" />
</c:url>
...
<td> <a href="${updateFormLink }"> Edit </a> | 
	 ...
	 <a href="${viewPassengersLink }"> Passengers </a> 
</td>
</tr>
</c:forEach>
